...
var ExercisesDB = mongoose.model("ExercisesDB", exercisesSchema);
...
app.post("/api/users/:_id/exercises", function (req, res) {
  ...
  UsersDB.findById(userId, function (err, data) {
    if (!err && data !== null) {
      let newExercise = new ExercisesDB({
        userId: userId,
...
app.get("/api/users/:_id/logs", function (req, res) {
  ...
  UsersDB.findById(userId, function (err, data) {
    if (!err && data !== null) {
      ExercisesDB.find(findConditions)
        .sort({ date: "asc" })
        .limit(limit)
